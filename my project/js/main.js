...
// testimonialSlider();
// function testimonialSlider() {
//   const carouselOne = new bootstrap.Carousel(
//     document.getElementById("carouselOne")
//   );
//   if (carouselOne) {
//     carouselOne._element.addEventListener("slid.bs.carousel", function (event) {
//       const activeItem = event.relatedTarget;
//       const imageElement = activeItem.querySelector(".js-testimonial-img");
//       if (imageElement) {
//         const imgSrc = imageElement.getAttribute("data-js-testimonial-img"); // Update this line
